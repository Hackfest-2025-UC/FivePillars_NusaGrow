            ...
            <li>
                <a href="{{ route('admin.dashboard') }}"
                    class="flex items-center p-2 rounded-lg group
                        {{ request()->routeIs('admin.dashboard') ? 'text-white dark:text-green-600 bg-green-500 dark:bg-gray-700' : 'text-gray-900 dark:text-white hover:bg-green-200 dark:hover:bg-gray-700' }}">
