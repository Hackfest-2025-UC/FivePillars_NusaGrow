...
@section('content')
    <h1 class="text-2xl font-semibold">Penawaran Masuk</h1>
    <div class="flex flex-col gap-5 mt-5">
        ...
        <div class="flex justify-between items-start">
            <div class="flex">
                ...
                <div>
                    <p class="font-semibold">{{ $penawaran->produk->nama_produk }}</p>
                    <p>{{ $penawaran->produk->harga }}</p>
                    <p>Deskripsi: {{ $penawaran->deskripsi_penawaran}}</p>
                    <p>Harga ditawar: {{ $penawaran->harga_penawaran}}</p>
                </div>
            </div>
