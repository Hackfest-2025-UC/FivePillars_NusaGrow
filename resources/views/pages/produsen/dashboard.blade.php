        ...
        <div class="flex justify-between mb-5 items-center">
            <div class="flex items-center gap-5">
                <div class="p-2 bg-primary rounded text-white">
                    <i class="text-2xl text-red-500 fa-solid fa-house"></i>
                </div>
            ...
            <div class="rounded-sm bg-slate-50 px-7 py-6 shadow-md dark:border-strokedark dark:bg-boxdark">
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium">Jumlah Produk</span>
                    </div>
            ...
            <div class="rounded-sm bg-slate-50 px-7 py-6 shadow-md dark:border-strokedark dark:bg-boxdark">
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-sm font-medium">Kebutuhan Produk</span>
                    </div>
